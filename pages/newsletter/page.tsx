...
export const ARTICLES: Article[] = [
  {
    ...
    contentBeforeImages: (
      <>
        <p className="mb-6 leading-relaxed" style={{ fontSize: '14px', color: 'var(--charcoal)', lineHeight: '1.8' }}>
    ...
    contentAfterImages: (
      <>
        <h3 style={{ fontSize: '16px', fontWeight: 400, color: 'var(--palette-text)', marginTop: '40px', marginBottom: '16px' }}>열심히의 함정</h3>
        <p className="mb-6 leading-relaxed" style={{ fontSize: '14px', color: 'var(--charcoal)', lineHeight: '1.8' }}>
        ...
        <h3 style={{ fontSize: '16px', fontWeight: 400, color: 'var(--palette-text)', marginTop: '40px', marginBottom: '16px' }}>노 빡빡</h3>
        <p className="mb-6 leading-relaxed" style={{ fontSize: '14px', color: 'var(--charcoal)', lineHeight: '1.8' }}>
    ...
    contentAfterSmallImages: (
      <>
        <h3 style={{ fontSize: '16px', fontWeight: 400, color: 'var(--palette-text)', marginTop: '40px', marginBottom: '16px' }}>쉬는 것도 일의 일부</h3>
        <p className="mb-6 leading-relaxed" style={{ fontSize: '14px', color: 'var(--charcoal)', lineHeight: '1.8' }}>
  ...
  },
  {
    ...
    contentAfterImages: (
      <>
        <h3 style={{ fontSize: '16px', fontWeight: 400, color: 'var(--palette-text)', marginTop: '40px', marginBottom: '16px' }}>정답이 없는 시대</h3>
        <p className="mb-6 leading-relaxed" style={{ fontSize: '14px', color: 'var(--charcoal)', lineHeight: '1.8' }}>
    ...
    contentAfterSmallImages: (
      <>
        <h3 style={{ fontSize: '16px', fontWeight: 400, color: 'var(--palette-text)', marginTop: '40px', marginBottom: '16px' }}>관계라는 자원</h3>
        <p className="mb-6 leading-relaxed" style={{ fontSize: '14px', color: 'var(--charcoal)', lineHeight: '1.8' }}>
  ...
  },
  {
    ...
    contentAfterImages: (
      <>
        <h3 style={{ fontSize: '16px', fontWeight: 400, color: 'var(--palette-text)', marginTop: '40px', marginBottom: '16px' }}>완벽주의라는 적</h3>
        <p className="mb-6 leading-relaxed" style={{ fontSize: '14px', color: 'var(--charcoal)', lineHeight: '1.8' }}>
    ...
    contentAfterSmallImages: (
      <>
        <h3 style={{ fontSize: '16px', fontWeight: 400, color: 'var(--palette-text)', marginTop: '40px', marginBottom: '16px' }}>라면도 집에서 끓이면 다르다</h3>
        <p className="mb-6 leading-relaxed" style={{ fontSize: '14px', color: 'var(--charcoal)', lineHeight: '1.8' }}>
  ...
  },
  {
    ...
    contentAfterImages: (
      <>
        <h3 style={{ fontSize: '16px', fontWeight: 400, color: 'var(--palette-text)', marginTop: '40px', marginBottom: '16px' }}>피해야 할 것들</h3>
        <p className="mb-6 leading-relaxed" style={{ fontSize: '14px', color: 'var(--charcoal)', lineHeight: '1.8' }}>
    ...
    contentAfterSmallImages: (
      <>
        <h3 style={{ fontSize: '16px', fontWeight: 400, color: 'var(--palette-text)', marginTop: '40px', marginBottom: '16px' }}>취향이 달라도 괜찮다</h3>
        <p className="mb-6 leading-relaxed" style={{ fontSize: '14px', color: 'var(--charcoal)', lineHeight: '1.8' }}>
  ...
  },
  {
    ...
    contentAfterImages: (
      <>
        <h3 style={{ fontSize: '16px', fontWeight: 400, color: 'var(--palette-text)', marginTop: '40px', marginBottom: '16px' }}>비싼 선물이 좋은 선물일까</h3>
        <p className="mb-6 leading-relaxed" style={{ fontSize: '14px', color: 'var(--charcoal)', lineHeight: '1.8' }}>
    ...
    contentAfterSmallImages: (
      <>
        <h3 style={{ fontSize: '16px', fontWeight: 400, color: 'var(--palette-text)', marginTop: '40px', marginBottom: '16px' }}>손편지의 힘</h3>
        <p className="mb-6 leading-relaxed" style={{ fontSize: '14px', color: 'var(--charcoal)', lineHeight: '1.8' }}>
    ...
    >
      ...
      <div
        style={{
          ...
          borderLeft: isLarge ? '1px solid var(--palette-text)' : 'none',
          borderTop: !isLarge ? '1px solid var(--palette-text)' : 'none',
        }}
      >
        <div>
          {/* 카테고리 */}
...
const ArticleDetail: React.FC<{
  ...
  return (
    ...
    >
      ...
      >
        <X size={20} color="var(--palette-text)" />
      </button>
