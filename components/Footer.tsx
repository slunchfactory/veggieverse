    ...
    <footer className="text-black w-full" style={{ backgroundColor: '#DCFD4A', borderTop: '1px solid var(--black)' }}>
      ...
      <div className="block md:hidden px-5 py-10">
        ...
        <div className="grid grid-cols-2 gap-x-5 gap-y-10 mb-10">
          ...
          {/* Column 3: CONTACT */}
          <div>
            <p className="text-[11px] font-normal tracking-widest uppercase mb-3 text-black">CONTACT</p>
            <a 
          ...
          {/* Column 4: SOCIAL */}
          <div>
            <p className="text-[11px] font-normal tracking-widest uppercase mb-3 text-black">SOCIAL</p>
            <a 
          ...
          {/* Column 5: BANK */}
          <div>
            <p className="text-[11px] font-normal tracking-widest uppercase mb-3 text-black">BANK</p>
            <p className="text-[14px] text-black font-mono mb-1">
          ...
          {/* Column 6: CS */}
          <div>
            <p className="text-[11px] font-normal tracking-widest uppercase mb-3 text-black">CS</p>
            <p className="text-[14px] text-black font-mono mb-1">
              032-224-6525
            </p>
            <p className="text-[13px] text-black leading-relaxed">
        ...
        <p 
          className="text-[10px] text-black leading-relaxed text-left break-keep"
      ...
      <div className="hidden md:block w-full max-w-[1440px] mx-auto px-10 py-12">
        ...
        <div className="grid grid-cols-5 gap-x-12 mb-12">
          ...
          <div>
            ...
            <p className="text-[13px] text-black font-normal leading-[1.8]">
              슬런치 에디터가 발행하는 아티클
            </p>
          </div>
          ...
          {/* Column 3: CONTACT */}
          <div>
            <p className="text-[11px] font-normal tracking-[0.15em] uppercase mb-4 text-black">CONTACT</p>
            <ul className="space-y-2">
              <li>
                <a 
                  href="mailto:slunch@slunch.co.kr" 
          ...
          {/* Column 4: SOCIAL */}
          <div>
            <p className="text-[11px] font-normal tracking-[0.15em] uppercase mb-4 text-black">SOCIAL</p>
            <ul className="space-y-2">
              <li>
                <a 
                  href="https://instagram.com/slunch_factory" 
          ...
          <div>
            <div className="mb-6">
              <p className="text-[11px] font-normal tracking-[0.15em] uppercase mb-4 text-black">BANK</p>
              <p className="text-[14px] text-black font-mono mb-1 leading-[1.8]">
                우리은행 1005-504-450570
              </p>
              <p className="text-[13px] text-black font-normal leading-[1.8]">
                (주)슬런치팩토리
            ...
            <div>
              <p className="text-[11px] font-normal tracking-[0.15em] uppercase mb-4 text-black">CS</p>
              <p className="text-[14px] text-black font-mono mb-1 leading-[1.8]">
                032-224-6525
              </p>
              <p className="text-[13px] text-black font-normal leading-[1.8]">
